        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white rounded-2xl shadow-sm border border-green-100 overflow-hidden">
                <div class="bg-green-600 px-6 py-4 flex items-center gap-3">
                    <div class="w-10 h-10 rounded-full bg-white text-green-700 flex items-center justify-center font-bold text-sm">
                        {{ strtoupper(substr($employee->name, 0, 1)) }}
                    </div>
                    <div>
                        <h3 class="text-white font-semibold">{{ $employee->name }}</h3>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="name" value="{{ old('name', $employee->name) }}"
                                   class="pl-9 w-full border-gray-300 focus:border-green-500 focus:ring-green-500 rounded-lg shadow-sm" required>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" name="salary" value="{{ old('salary', $employee->salary) }}"
                                   class="pl-7 w-full border-gray-300 focus:border-green-500 focus:ring-green-500 rounded-lg shadow-sm" required>
                        </div>
                    </div>
